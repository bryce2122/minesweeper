...
var _board = __webpack_require__(89);
...
var _minesweeper = __webpack_require__(52);
...
var Game = function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.state = { board: "", gameInSession: false };
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      return this.state.gameInSession ? _react2.default.createElement(
        'div',
        { style: containerStyle },
        _react2.default.createElement(_board2.default, { board: this.state.board }),
        _react2.default.createElement(
          'button',
          { style: buttonStyle, onClick: this.newGame },
          'New Game'
        )
      ) : _react2.default.createElement(_form2.default, { startGame: this.startGame });
    }
  }]);
...
var _square = __webpack_require__(91);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.board.grid.map(function (row, idx) {
          return _react2.default.createElement(
            'div',
            { key: idx, style: rowDivStyle },
            row.map(function (square, idx2) {
              return _react2.default.createElement(_square2.default, { square: square,
                key: idx2 });
            })
          );
        })
  ...
  _createClass(Form, [{
    ...
    value: function update(property) {
      ...
      return function (e) {
        ...
        if (!isNaN(value)) {
          return _this2.setState(_defineProperty({}, property, parseInt(e.target.value)));
        } else {
...
var Square = function (_React$Component) {
  ...
  _createClass(Square, [{
    key: 'render',
    value: function render() {
      var mined = this.props.square.mined;
      var openSquare = _react2.default.createElement(
        'div',
        { style: openedDivStyle },
        '\uD83D\uDCA3'
      );
      var closedSquare = _react2.default.createElement('div', { style: coveredDivStyle });
      return mined ? openSquare : closedSquare;
    }
  }]);
